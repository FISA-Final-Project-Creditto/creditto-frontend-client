...
import EmojiA from "./components/EmojiA";
    ...
    <main className="h-dvh flex justify-center items-center bg-[#e5e5e5]">
      <div className="w-full max-w-[440px] min-h-dvh mx-auto justify-start flex flex-col bg-white">
        ...
        <div className="mt-8 text-2xl font-bold text-left ml-5 h-20">
          <span className="text-[#0C72BA] font-bold text-[26px]">신용분석 레포트</span>{" "}
           <br />
        ...
        <div className="mt-5 text-xl font-medium text-left ml-5 h-15">
          <span>한국에서 사용하던 신용점수</span>
          <br />
          <span>이제 해외에서도 그대로 쓸 수 있어요</span>
        </div>
        <div className="mt-5 text-xl font-medium text-left ml-5 h-15">
        ...
        >
          <div className="px-3 pb-6 text-sm">
            <div className="bg-gray-100 p-3 rounded-lg mb-4 text-xs text-gray-600">
              <p className="mb-2">
                본 약관에 동의하시면 우리은행 해외 지사에서 고객님의 신용
                점수를 이전하여 활용할 수 있습니다.
              </p>
              <p className="font-medium">
                <span className="font-semibold">유의사항:</span> 국가별 신용 측정 기준의 차이로 인해 이전된 점수가 그대로 반영되지 않을 수 있습니다.
              </p>
            </div>
            {/* 체크 항목 */}
